...
User.create(:email => "sanji@strawhat-pirates.jp", :username => "sanji", :first_name => "Sanji", :last_name => nil)
User.create(:email => "zorro@strawhat-pirates.jp", :username => "zorro", :first_name => "Zorro", :last_name => "Lorenor")
